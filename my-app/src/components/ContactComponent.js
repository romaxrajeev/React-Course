...
class Contact extends Component {
    ...
    handleInputChange(event){
        const target = event.target; //Which input is changed
        const value = target.type === 'checkbox' ? target.checked : target.value; //If checkbox, then get checked. Else value
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="tel" id="telnum" name="telnum" placeholder="Telephone Number" value={this.state.telnum} valid={errors.telnum === ''} invalid={errors.telnum !== ''} onChange={this.handleInputChange} onBlur={this.handleBlur('telnum')} />
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" placeholder="Enter your feedback" rows="12" value={this.state.message} onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
