                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values) =>this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" className="form-control" id="telnum" name="telnum" placeholder="Telephone Number" />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".feedback" className="form-control" id="message" name="message" placeholder="Enter your feedback" rows="12" />
                                </Col>
                            </Row>
                            <Row className="form-group">
